      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link to="/">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" className="w-12 h-12 fill-blue-600">
            ...
            <button type="button" onClick={menuState} className="md:hidden text-2xl">
              ☰
            </button>
          </div>
      ...
      {menu && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
          <div className="bg-white w-64 h-full p-6">
            <button onClick={menuState} className="text-2xl mb-8">✕</button>
            <nav className="flex flex-col gap-4">
              <Link to="/" className="text-lg hover:text-blue-600" onClick={menuState}>
                Početna stranica
              </Link>
              <Link to="/help" className="text-lg hover:text-blue-600" onClick={menuState}>
                Pomoć
              </Link>
              ...
              {isAuthenticated && (
                <>
                  <Link to="/account" className="text-lg hover:text-blue-600" onClick={menuState}>
                    Moj nalog
                  </Link>
                  {isAdmin && (
