      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            {isAuthenticated && (
              <>
                <Link to="/tickets" className="text-gray-300 hover:text-white">Moje karte</Link>
                <Link to="/account" className="text-gray-300 hover:text-white">Moj nalog</Link>
              </>
            )}
            {isAdmin && (
              <Link to="/admin/dashboard" className="text-gray-300 hover:text-white">Admin Panel</Link>
            )}
          </div>
          ...
          {/* Login/Registracija ili User info */}
          <div className="flex flex-col gap-4">
            {!isAuthenticated ? (
              <>
                <Link to="/register" className="text-gray-300 hover:text-white">Registrujte se</Link>
                <span className="text-gray-500">ili</span>
                <ButtonLink color="blue-filled" text="Prijavite se" url="login" />
              </>
            ) : (
              <div className="text-gray-300">
                <p className="mb-2">Prijavljeni ste</p>
                <Link to="/account" className="text-blue-400 hover:text-blue-300">
                  Idite na nalog →
                </Link>
              </div>
            )}
