...
class TicketTypeController extends Controller
{
    ...
    #[OA\Post(
        ...
        description: "Admin only - Creates a new ticket type for an event",
        parameters: [
            new OA\Parameter(
                name: "event",
                in: "path",
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(property: "quantity_sold", type: "integer", example: 0),
                    new OA\Property(property: "sales_start_at", type: "string", format: "date-time", example: "2026-06-01 10:00:00"),
                    new OA\Property(property: "sales_end_at", type: "string", format: "date-time", example: "2026-07-15 18:00:00"),
                    new OA\Property(property: "is_active", type: "boolean", example: true),
                ]
            )
        ),
        responses: [
            new OA\Response(response: 201, description: "Ticket type created successfully"),
